package jp.ac.std.it_college.s22019.mediasample
...
import jp.ac.std.it_college.s22019.mediasample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mediaFileUri = Uri.parse(
            "android.resource://${packageName}/${R.raw.ei}"
        )
        mediaPlayer?.apply {
